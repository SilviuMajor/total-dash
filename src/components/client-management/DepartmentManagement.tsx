...
const DEPARTMENT_COLORS = DEPT_FAMILIES.map(value => ({
  value,
  label: DEPT_FAMILY_LABELS[value],
}));
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      {(() => {
                        const dot = deptColorClasses(dept.color || 'sky');
                        return (
                          <span
                            className={cn("inline-block w-4 h-4 rounded-md flex-shrink-0", dot.className)}
                            style={dot.style}
                          />
                        );
                      })()}
              ...
              {activeDragId ? (() => {
                ...
                return (
                  <div className="flex items-center gap-3 px-4 py-3 rounded-lg border border-primary/30 bg-card shadow-lg opacity-90">
                    ...
                    {(() => {
                      const dot = deptColorClasses(dept.color || 'sky');
                      return <span className={cn("inline-block w-4 h-4 rounded-md", dot.className)} style={dot.style} />;
                    })()}
